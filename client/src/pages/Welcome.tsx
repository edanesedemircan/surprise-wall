    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          padding: isMobile ? '3rem 1.5rem' : '6.25rem 4rem',
          textAlign: 'center',
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <h4 style={{ color: '#FFF1F2', margin: '0 0 1rem 0', fontSize: isMobile ? '22px' : '28px', fontWeight: '800' }}> ❤️ Romantik Anılar</h4>
              <p style={{ color: '#FFE4E6', fontSize: isMobile ? '13px' : '15px', maxWidth: '550px', margin: 0, lineHeight: '1.7' }}>
            ...
            <div style={{ 
              ...
              <h4 style={{ color: '#F8FAFC', margin: '0 0 1rem 0', fontSize: isMobile ? '22px' : '28px', fontWeight: '800' }}>🎓 Kep Fırlatma Sevinci</h4>
              <p style={{ color: '#E2E8F0', fontSize: isMobile ? '13px' : '15px', maxWidth: '550px', margin: 0, lineHeight: '1.7' }}>
            ...
            <div style={{ 
              ...
              <h4 style={{ color: '#FEF3C7', margin: '0 0 1rem 0', fontSize: isMobile ? '22px' : '28px', fontWeight: '800' }}>💼 Yeni Başlangıçlar</h4>
              <p style={{ color: '#FDE68A', fontSize: isMobile ? '13px' : '15px', maxWidth: '550px', margin: 0, lineHeight: '1.7' }}>
            ...
            <div style={{ 
              ...
              <h4 style={{ color: '#FCE7F3', margin: '0 0 1rem 0', fontSize: isMobile ? '22px' : '28px', fontWeight: '800' }}>🎉 Sebepsizce Sadece Kutlamak İstediklerimiz</h4>
              <p style={{ color: '#FBCFE8', fontSize: isMobile ? '13px' : '15px', maxWidth: '550px', margin: 0, lineHeight: '1.7' }}>
      ...
      {/* SAĞ PANEL (Sadece Masaüstünde Sticky Olarak Yan Tarafında Kalır!) */}
      {!isMobile && (
        <div style={{ 
          width: '350px', 
          position: 'sticky',
