  ...
  return (
    <div style={fullScreenStyle}>
      ...
      `}</style>
        ...
        {/* ✨ SEÇENEK 2: GRADYAN IŞIK BANTLI (GLOW) MODERN ÜST PANEL */}
<div style={{
  width: '100vw',
  ...
  {/* ✍️ Saf, Tırnaksız ve Asil Başlık */}
  <h1 style={{
  ...
  {/* 🌈 Merkezde Belirgin, Kenarlarda Tamamen Şeffaflaşan Modern Gradyan Işık Bandı */}
  <div style={{
    width: '100%',
    maxWidth: '800px', // Çizginin odak noktasını merkezde tutar
    height: '2px', // Çok ince ve elit durması için
    background: `linear-gradient(to right, 
      transparent, 
      ${
        normalizedTheme === 'romantic' ? 'rgba(160, 43, 106, 0.6)' :
        normalizedTheme === 'graduation' ? 'rgba(30, 64, 175, 0.6)' :
        normalizedTheme === 'job' ? 'rgba(21, 128, 61, 0.6)' :
        normalizedTheme === 'funny' ? 'rgba(180, 83, 9, 0.6)' :
        'rgba(90, 62, 62, 0.6)'
      } 50%, 
      transparent
    )`,
    // Çizginin altına hafif bir parıltı (aura) derinliği ekliyoruz:
    boxShadow: `0 1px 10px ${
      normalizedTheme === 'romantic' ? 'rgba(160, 43, 106, 0.3)' :
      normalizedTheme === 'graduation' ? 'rgba(30, 64, 175, 0.3)' :
      normalizedTheme === 'job' ? 'rgba(21, 128, 61, 0.3)' :
      normalizedTheme === 'funny' ? 'rgba(180, 83, 9, 0.3)' :
      'rgba(90, 62, 62, 0.3)'
    }`
  }} />
</div>
